        ...
        <div class="box-body">
            <div class="fields-group">
                <div class="form-group  ">
                    ...
                    <label class="control-label" for="inputError"><span id="check-add-days-message" style="color: #dd4b39"></span></label>
                    <div class="col-sm-2" style="display: inline-flex">
                        <div class="input-group">
                            <input style="width: 150px; text-align: center;" type="text" id="add_validity_period" name="add_validity_period" value="0" class="form-control validity_period initialized" placeholder="增加有效期限/天">
                        </div>
...
<script>
    ...
    function checkaddDays() {
        ...
        if(add_validity_period == '' || add_validity_period == 0){
            $('#check-add-days-message').html("增加天数不能为空或0");
            return false;
        }
